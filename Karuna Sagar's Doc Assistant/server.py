...
def process_document_route():
    ...
    if 'file' not in request.files:
        return jsonify({
            "botResponse": "It seems like the file was not uploaded correctly Karuna, can you try "
    ...
    return jsonify({
        "botResponse": "Thank you Karuna Sagar for providing your PDF document. I have analyzed it, so now you can ask me any "
