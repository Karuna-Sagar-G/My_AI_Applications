...
const populateBotResponse = async (userMessage) => {
  ...
  if (isFirstMessage) {
    response = { botResponse: "Hello Karuna Sagar! I'm your friendly data assistant, ready to answer any questions regarding your data. Could you please upload a PDF file for me to analyze?"};
    uploadButtonHtml = `
